simple_good_turing <- function(freq){
  
  # Simple Good Turing smoothing
  #
  # There is supposed to be a function called sgt (for Simple Good-Turing)
  # in the package corpustools, and while there is a brief help file for function sgt
  # it does not actually exist as shown by library(corpustools), ls("package:corpustools").
  # However, I found code that also has the same content as the brief help file, and
  # with corpustools, but called smoothing.r:
  # https://github.com/kasperwelbers/corpustools/blob/master/R/smoothing.r
  # So I took that code, and made this function.
  #
  # Implementation of the Simple Good Turing smoothing proposed in: 
  # Gale, W. A., & Sampson, G. (1995). Good Turing frequency estimation without tears. 
  # Journal of Quantitative Linguistics, 2(3), 217-237.
  #
  # freq: A numeric vector of frequencies (integers).
  # Returns a numeric vector with the smoothed term proportions (fractions of sum of freq)
